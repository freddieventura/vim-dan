...
rm ${DOCU_PATH}/downloaded/www.typescriptlang.org/manifest.webmanifest
rm ${DOCU_PATH}/downloaded/www.typescriptlang.org/docs/home.html
rm ${DOCU_PATH}/downloaded/www.typescriptlang.org/docs/index.html

mv ${DOCU_PATH}/downloaded/www.typescriptlang.org/docs/handbook/* ${DOCU_PATH}/downloaded/
rm -r ${DOCU_PATH}/downloaded/www.typescriptlang.org/
...
for path in "${sorted_paths_array[@]}"; do
    ...
    # (Multi-rule) Parsing functions , add as many as you want
    f1() { pup -i 0 --pre 'article div.whitespace' | pandoc -f html -t plain ;}
