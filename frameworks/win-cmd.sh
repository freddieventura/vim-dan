...
DOWNLOAD_LINK="https://learn.microsoft.com/en-us/windows/win32/debug/system-error-codes--0-499-"
# -------------------------------------
...
mv ${DOCU_PATH}/downloaded/downloaded/en-us/windows-server/administration ${DOCU_PATH}/downloaded/

wget https://www.groovypost.com/howto/windows-10-keyboard-shortcuts/ -O ${DOCU_PATH}/windows10-keyboard-shortcuts.html
