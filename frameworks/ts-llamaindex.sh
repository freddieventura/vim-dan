...
## Removing files of no interest
rm -r ${DOCU_PATH}/downloaded/ts.llamaindex.ai/assets
rm -r ${DOCU_PATH}/downloaded/ts.llamaindex.ai/blog

rm ${DOCU_PATH}/downloaded/ts.llamaindex.ai/api.html
rm ${DOCU_PATH}/downloaded/ts.llamaindex.ai/blog.html
rm ${DOCU_PATH}/downloaded/ts.llamaindex.ai/index.html
...
mv ${DOCU_PATH}/downloaded/ts.llamaindex.ai/* ${DOCU_PATH}/downloaded/
rm -r ${DOCU_PATH}/downloaded/ts.llamaindex.ai
...
for path in "${sorted_paths_array[@]}"; do
    ...
    # (Multi-rule) Parsing functions , add as many as you want
    f1() { pup -i 0 --pre 'div.theme-doc-markdown' | pandoc -f html -t plain ;}
