...
mv ${DOCU_PATH}/downloaded/docs.oracle.com/javase/specs/jls/se21/html/* ${DOCU_PATH}/downloaded/
rm -r ${DOCU_PATH}/downloaded/docs.oracle.com/ 

rm ${DOCU_PATH}/downloaded/index.html
rm ${DOCU_PATH}/downloaded/spec-frontmatter.html
rm ${DOCU_PATH}/downloaded/spec-license.html
...
for path in "${files_array[@]}"; do
    ...
    # (Multi-rule) Parsing functions , add as many as you want
    f1() { pup -i 0 --pre 'div.chapter' | pandoc -f html -t plain --wrap=none;}
