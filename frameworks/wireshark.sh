...
mapfile -t files_array < <(find "${DOCU_PATH}/downloaded" -type f \
    \( ! -path "${DOCU_PATH}/downloaded/wireshark.org/docs/wsdg_html" \
    ! -path "${DOCU_PATH}/downloaded/wireshark.org/docs/wsdg_html.html" \
    ! -path "${DOCU_PATH}/downloaded/wireshark.org/docs/wsdg_html_chunked.html" \
    ! -path "${DOCU_PATH}/downloaded/wireshark.org/docs/wsug_html" \
