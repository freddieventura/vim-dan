...
syn match danTestObjectives "^Test Objectives\%(\s(X)\)\{,1}$" contains=danX
hi def link danTestObjectives TabLine

syn match danTestingObjectives "^Testing Objectives\%(\s(X)\)\{,1}$" contains=danX
hi def link danTestingObjectives TabLine

syn match danHowtoTest "^How to Test\%(\s(X)\)\{,1}$" contains=danX
hi def link danHowtoTest TabLine
...
hi def link danReferences TabLine

syn match danFigure "^Figure\%(.\)*$" contains=danX
hi def link danFigure TabLine

syn match danRemediation "^Remediation\%(\s(X)\)\{,1}$" contains=danX
hi def link danRemediation TabLine

syn match danTools "^Tools\%(\s(X)\)\{,1}$" contains=danX
hi def link danTools TabLine
